...
class StopMatcherTest(unittest.TestCase):
	...
	def _do_test_rank_platform(self, official_platform_code, osm_assumed_platform_code, expected):
		...
		actual = matcher.rank_platform(stop, osm_stop)
	...
	def test_rank_platform(self):
		self._do_test_rank_platform("2", "1", 0.0)
		self._do_test_rank_platform("", "", 0.9)

	def test_rank_successor(self):
		self._do_test_rank_successor("Stuttgart", "", "Ri Stuttgart Niebuhrweg", "Wollinstraße", "Niebuhrweg", -1)
		...
		self._do_test_rank_successor("Stuttgart", "", "Ri Stuttgart Wurmlinger Straße/Stuttgart Leinfeldener Straße", "Leinfeldener Straße/Wurmlinger Straße", "Reutlinger Straße", 1)
		...
		self._do_test_rank_successor("Pforzheim", "", "Ri 1.CfR Stadion/Hohlohstraße", "Wohnlichstraße", "1.CfR Stadion", -1)
		self._do_test_rank_successor("Idstein", "Idstein-Wörsdorf ", "Ri Idstein Bahnhof", "Idstein", "Bad Camberg", 0)
		self._do_test_rank_successor("Idstein", "Idstein-Wörsdorf ", "Ri Idstein Bahnhof", "Bad Camberg", "Idstein", 0)
